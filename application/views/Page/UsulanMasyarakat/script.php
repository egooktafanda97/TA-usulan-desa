...
<script>
    ...
    $(".validasi").click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= base_url("Usulan/terima_usulan/") ?>" + id
                }
            });
    });
    $(".tolak").click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= base_url("Usulan/tolak_usulan/") ?>" + id
                }
            });
    });
    // deletes
    ...
    $("#defaultCheck1").click(function() {
        if (!$(this).is(":checked")) {
            $(".docPen").html(`<div class="form-group">
    ...
    $(".proses").click(function() {
        var id = $(this).data("id");
        $("[name='id_usulan_masyarakat']").val(id);
