    ...
    <div class="root-container">
        <div style="display: flex; justify-content: space-between; align-items: center">
            ...
            <div style="" style="display: flex; justify-content: center;align-items: center">
                <center>
                    <h2 style="margin: 0;padding: 0; text-align: center"><?= strtoupper("REKAPITULASI USULAN MUSRENBANG " . $user['nama_kecamatan']) ?>
                ...
                <td style="width: 40%;">
                    <div style="width: 100%; display: flex; justify-content: flex-end;">
                        <div style="margin-right: 30px;">
                            <div><?= $user['nama_kecamatan'] ?>, <?= tgl_i(date("Y-m-d")) ?></div>
                            <strong>Kepala Camat</strong>
                            <br />
                            <br />
                            <br />
                            <br />
                            <div>
                                <u><?= strtoupper($user['nama_camat']) ?></u>
                                <br>
                                </small>
                            </div>
                        </div>
