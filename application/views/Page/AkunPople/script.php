...
<script>
    ...
    $(".blokir").click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= base_url("p/deleteUserPopleBlock/") ?>" + id
                }
            });
    })
    $(".unBlock").click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= base_url("p/deleteUserPopleunBlock/") ?>" + id
                }
            });
    })
</script>